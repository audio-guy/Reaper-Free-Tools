...
name = "SYNC" -- Custo mame
color = "#69EEEE" -- Hex value
...
if reaper.GetNumTakeMarkers then
  ...
  reaper.Undo_EndBlock("Add SYNC take markers to selected takes at play cursor position", -1) -- End of the undo block. Leave it at the bottom of your main function.
